...
public class ConsultaDAO {
    ...
    /**
     * SELECT * FROM vw_cinturoes_em_disputa
     */
    ...
    /**
     * SELECT * FROM vw_lutadores_atividade
     */
     ...
     * FROM luta lu JOIN cardppv cp ON lu.id_card = cp.id_card
    ...
    /**
     * SELECT * FROM log_troca_cinturao ORDER BY data_hora DESC
     */
    ...
    /**
     * SELECT fn_receita_por_pagante(?) AS receita_por_pagante
     */
