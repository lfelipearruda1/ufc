...
public class CardDAO {
    ...
    private int proximoId(Connection conn) throws SQLException {
        // SELECT COALESCE(MAX(id_card), 0) + 1 FROM card
    ...
    /**
     * SELECT * FROM card ORDER BY data DESC
     */
    ...
    /**
     * INSERT INTO card (id_card, cidade, data, pais, quant_lutas) VALUES (?, ?, ?, ?, ?)
     */
    ...
    /**
     * UPDATE card SET cidade=?, data=?, pais=?, quant_lutas=? WHERE id_card=?
     */
