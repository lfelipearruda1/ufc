...
public class DivisaoDAO {
    ...
    private int proximoId(Connection conn) throws SQLException {
        // SELECT COALESCE(MAX(id_divisao), 0) + 1 FROM divisao
    ...
    /**
     * SELECT * FROM divisao ORDER BY nome_divisao
     */
    ...
    /**
     * SELECT * FROM divisao WHERE id_divisao = ?
     */
    ...
    /**
     * INSERT INTO divisao (id_divisao, nome_divisao, peso_max, peso_min) VALUES (?, ?, ?, ?)
     */
    ...
    /**
     * UPDATE divisao SET nome_divisao=?, peso_max=?, peso_min=? WHERE id_divisao=?
     */
    ...
    /**
     * DELETE FROM divisao WHERE id_divisao=?
     */
    ...
    /**
     * CALL sp_recalcular_carteis_divisao(?)
     */
